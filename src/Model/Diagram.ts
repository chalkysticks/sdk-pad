...
export class Diagram extends Model.Base {
	 ...
	 * @type string[]
	 */
	public fields: string[] = ['id', 'hash', 'diagram', 'layout', 'table_type', 'ball_type', 'ball_count', 'is_complete', 'version', 'created_at', 'updated_at'];

	/**
	 * For v2, this is actually https://pad.chalkysticks.com/
	 * That's handled by the getUrl method
	 *
	 * @type string
	 */
